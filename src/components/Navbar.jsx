      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <div>
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-widest">Platform</p>
              <p className="text-base font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent hidden sm:block">
                Incredible
              </p>
            </div>
          </div>
          ...
          <div className="hidden lg:flex gap-6 items-center">
            {navLinks.map((link) => (
              <a
                ...
                className="text-gray-700 font-medium hover:text-indigo-600 transition relative group"
              >
                {link}
