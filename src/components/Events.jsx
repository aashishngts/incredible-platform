...
export default function Events() {
  ...
  return (
    <section
      id="events"
      className="relative py-28 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white overflow-hidden font-sans"
    >
      {/* Background Glow */}
                ...
                <div className="relative p-8 flex flex-col justify-between h-full">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-5">
                      <span className="px-3 py-1 text-xs font-medium bg-white/30 backdrop-blur-md text-indigo-700 rounded-full border border-white/40">
                        {event.category}
                      </span>
                    ...
                    <h3 className="font-heading text-xl font-semibold text-gray-900 mb-5 group-hover:text-indigo-600 transition">
                      {event.title}
                    </h3>
